...
const oldTooltip = /<div class="custom-effect-tooltip"><b>\{\{ effect\.name \}\}<\/b><span \*ngIf="effect\.description"><br>\{\{ effect\.description \}\}<\/span><span \*ngIf="effect\.remainingTurns\s*>\s*0"><br><i>Continues for \{\{ effect\.remainingTurns \}\} turns<\/i><\/span><\/div>/g;
...
html = html.replace(oldTooltip, newTooltip);
